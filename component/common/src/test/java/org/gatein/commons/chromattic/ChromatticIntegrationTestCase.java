 ...
 */
package org.gatein.commons.chromattic;
...
import org.gatein.component.test.*;
...
@ConfiguredBy({
   ...
   @ConfigurationUnit(scope = ContainerScope.PORTAL, path = "org/gatein/commons/chromattic/configuration.xml")
})
