package org.gatein.commons.scope;

import org.gatein.commons.scope.ScopeManager;
...
@ConfiguredBy({
   ...
   @ConfigurationUnit(scope = ContainerScope.PORTAL, path = "org/gatein/commons/scope/configuration.xml")
})
