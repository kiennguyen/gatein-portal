...
import org.gatein.commons.xml.DocumentSource;
import org.gatein.portal.resource.config.tasks.SkinConfigTask;
import org.gatein.portal.resource.config.xml.SkinConfigParser;
...
{   
   ...
   {
      assertDescriptorCanBeLoaded("org/gatein/portal/resource/gatein-resources-1_0.xml");
   }

   public void testResources1_0WithSkinModule() throws MalformedURLException
   {
      assertDescriptorCanBeLoaded("org/gatein/portal/resource/gatein-resources-1_0-with-skin-module.xml");
   }

   public void testResources1_1() throws MalformedURLException
   {
      assertDescriptorCanBeLoaded("org/gatein/portal/resource/gatein-resources-1_1.xml");
   }

   public void testResources1_2() throws MalformedURLException
   {
      assertDescriptorCanBeLoaded("org/gatein/portal/resource/gatein-resources-1_2.xml");
   }
