...
public class GenericHttpListener extends AbstractHttpSessionListener implements ServletContextListener
{
    ...
    */
   public static final String SESSION_CREATED = "org.gatein.web.GenericHttpListener.sessionCreated";

   /**
    * The name of the "session destroyed" event
    */
   public static final String SESSION_DESTROYED = "org.gatein.web.GenericHttpListener.sessionDestroyed";

   /**
    * The name of the "context initialized" event
    */
   public static final String CONTEXT_INITIALIZED = "org.gatein.web.GenericHttpListener.contextInitialized";

   /**
    * The name of the "context destroyed" event
    */
   public static final String CONTEXT_DESTROYED = "org.gatein.web.GenericHttpListener.contextDestroyed";
