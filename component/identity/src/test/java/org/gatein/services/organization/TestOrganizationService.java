...
package org.gatein.services.organization;
...
import org.gatein.services.organization.idm.Config;
import org.gatein.services.organization.idm.PicketLinkIDMOrganizationServiceImpl;
import org.gatein.services.organization.idm.UserDAOImpl;
...
@ConfiguredBy({
   ...
   @ConfigurationUnit(scope = ContainerScope.PORTAL, path = "org/gatein/services/organization/TestOrganizationService-configuration.xml")
})
