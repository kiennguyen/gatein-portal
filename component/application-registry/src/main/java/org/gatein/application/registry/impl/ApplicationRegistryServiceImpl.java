 ...
 */
package org.gatein.application.registry.impl;
...
import org.gatein.application.registry.ApplicationCategoriesPlugins;
...
public class ApplicationRegistryServiceImpl implements ApplicationRegistryService, Startable
{
   ...
   public void importExoGadgets() throws Exception
   {
      ...
      if (eXoGadgets != null)
      {
         ...
         for (Gadget ele : eXoGadgets)
         {
            ...
            if (app == null)
            {
               app = category.createContent(ele.getName(), org.gatein.portal.pom.spi.gadget.Gadget.CONTENT_TYPE, ele.getName());
   ...
   private static String getApplicationIconURL(ContentDefinition contentDef)
   {
      ...
      if (customization != null)
      {
         ...
         else if (type == org.gatein.portal.pom.spi.gadget.Gadget.CONTENT_TYPE)
         {
