...
package org.gatein.portal.mop.management.binding.xml;

import junit.framework.TestCase;

import org.gatein.portal.config.model.I18NString;
...
import org.gatein.portal.mop.management.binding.xml.NavigationMarshaller;
...
public class NavigationMarshallerTest extends TestCase
{
   public void testNavigationUnmarshalling()
   {
      ...
      PageNavigation data = marshaller.unmarshal(getClass().getResourceAsStream("/org/gatein/portal/mop/management/navigation.xml"));
      assertNotNull(data);
   ...
   {
      NavigationMarshaller marshaller = new NavigationMarshaller();
      PageNavigation data = marshaller.unmarshal(getClass().getResourceAsStream("/org/gatein/portal/mop/management/navigation-empty.xml"));
      assertNotNull(data);
   ...
   {
      NavigationMarshaller marshaller = new NavigationMarshaller();
      PageNavigation data = marshaller.unmarshal(getClass().getResourceAsStream("/org/gatein/portal/mop/management/navigation-fragment.xml"));
      assertNotNull(data);
   ...
   {
      NavigationMarshaller marshaller = new NavigationMarshaller();
      PageNavigation data = marshaller.unmarshal(getClass().getResourceAsStream("/org/gatein/portal/mop/management/navigation-extended.xml"));
      assertNotNull(data);
      assertNotNull(data.getFragment().getNodes());
