...
import org.gatein.component.test.KernelBootstrap;
...
public abstract class AbstractDataImportTest extends AbstractGateInTest
{
   ...
   public void testOneBootWithExtension() throws Exception
   {
      ...
      bootstrap.addConfiguration(ContainerScope.PORTAL, "org/gatein/portal/config/TestImport1-configuration.xml");
      bootstrap.addConfiguration(ContainerScope.PORTAL, "org/gatein/portal/config/TestImport2-configuration.xml");
