...
package org.gatein.portal.mop.user;
...
import org.gatein.portal.mop.user.UserNodeFilterConfig.Builder;
...
@ConfiguredBy({
   ...
   @ConfigurationUnit(scope = ContainerScope.PORTAL, path = "org/gatein/portal/mop/user/configuration.xml")
})
