...
import org.gatein.portal.mop.management.binding.xml.SiteLayoutMarshaller;
...
public class SiteLayoutMarshallerTest extends AbstractMarshallerTest
{
   public void testPortalDataUnmarshalling()
   {
      ...
      PortalConfig data = marshaller.unmarshal(getClass().getResourceAsStream("/org/gatein/portal/mop/management/portal.xml"));
      assertNotNull(data);
