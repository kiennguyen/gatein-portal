...
import org.gatein.portal.application.PortletPreferences.PortletPreferencesSet;
import org.gatein.portal.config.model.Application;
import org.gatein.portal.config.model.LocalizedString;
import org.gatein.portal.config.model.ModelUnmarshaller;
import org.gatein.portal.config.model.NavigationFragment;
import org.gatein.portal.config.model.Page;
import org.gatein.portal.config.model.PageNavigation;
...
import org.gatein.portal.config.model.UnmarshalledObject;
import org.gatein.portal.config.model.Version;
import org.gatein.portal.config.model.Page.PageSet;
...
public class TestJIBXXmlMapping extends AbstractGateInTest
{
   ...
   public void testPageSetMapping() throws Exception
   {
      ...
      Object obj =
         uctx.unmarshalDocument(new FileInputStream("src/test/resources/org/gatein/portal/config/conf/portal/classic/pages.xml"), null);
   ...
   public void testPortalConfigMapping() throws Exception
   {
      ...
      IUnmarshallingContext uctx = bfact.createUnmarshallingContext();
      Object obj =
         uctx.unmarshalDocument(new FileInputStream("src/test/resources/org/gatein/portal/config/conf/portal/classic/portal.xml"), null);
   ...
   public void testNavigationMapping() throws Exception
   {
      ...
      IUnmarshallingContext uctx = bfact.createUnmarshallingContext();
      Object obj =
         uctx.unmarshalDocument(new FileInputStream("src/test/resources/org/gatein/portal/config/conf/portal/classic/navigation.xml"), null);
   ...
   public void testPortletPreferencesMapping() throws Exception
   {
      ...
      Object obj =
         uctx.unmarshalDocument(
            new FileInputStream("src/test/resources/org/gatein/portal/config/conf/portal/classic/portlet-preferences.xml"), null);
