...
{
   public final static String PAGE_CREATED = "org.gatein.portal.config.DataStorage.pageCreated".intern();
   
   public final static String PAGE_REMOVED = "org.gatein.portal.config.DataStorage.pageRemoved".intern();

   public final static String PAGE_UPDATED = "org.gatein.portal.config.DataStorage.pageUpdated".intern();

   public final static String PORTAL_CONFIG_CREATED = "org.gatein.portal.config.DataStorage.portalConfigCreated".intern();

   public final static String PORTAL_CONFIG_REMOVED = "org.gatein.portal.config.DataStorage.portalConfigRemoved".intern();

   public final static String PORTAL_CONFIG_UPDATED = "org.gatein.portal.config.DataStorage.portalConfigUpdated".intern();
