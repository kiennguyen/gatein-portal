...
import org.gatein.portal.webui.page.UIPageForm;
   ...
   public void processRender(WebuiRequestContext context) throws Exception
   {
      ...
      if (portalMode != UIPortalApplication.NORMAL_MODE)
      {
         ...
         else if (uiComponent instanceof UIContainerList)
         {
            ...
            {
               Util.showComponentEditInViewMode(org.gatein.portal.webui.container.UIContainer.class);
            }
            else
            {
               uiPortalApp.setModeState(UIPortalApplication.CONTAINER_BLOCK_EDIT_MODE);
               Util.showComponentLayoutMode(org.gatein.portal.webui.container.UIContainer.class);
            }
         }
      }
