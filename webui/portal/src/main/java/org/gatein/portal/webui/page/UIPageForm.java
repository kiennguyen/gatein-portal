...
import org.gatein.webui.form.UIFormPopupWindow;
...
import org.gatein.webui.organization.UIGroupMembershipSelector;
import org.gatein.webui.organization.UIListPermissionSelector;
import org.gatein.webui.organization.UIPermissionSelector;
import org.gatein.webui.organization.UIListPermissionSelector.EmptyIteratorValidator;
...
public class UIPageForm extends UIFormTabPane
{
   ...
   public void buildForm(UIPage uiPage) throws Exception
   {
      ...
      if (uiPage == null || (!uiPage.getSiteKey().getType().equals(SiteType.USER) && getChildById("PermissionSetting") == null))
      {
         ...
         uiEditPermission.addValidator(org.gatein.webui.organization.UIPermissionSelector.MandatoryValidator.class);
