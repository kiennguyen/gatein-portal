...
import org.gatein.portal.application.RequestNavigationData;
...
import org.gatein.portal.resource.Skin;
import org.gatein.portal.resource.SkinConfig;
import org.gatein.portal.resource.SkinService;
import org.gatein.portal.resource.SkinURL;
import org.gatein.portal.webui.application.UIPortlet;
import org.gatein.portal.webui.page.UISiteBody;
import org.gatein.portal.webui.page.UIPageActionListener.ChangeNodeActionListener;
import org.gatein.portal.webui.portal.PageNodeEvent;
   ...
   private void initWorkspaces() throws Exception
   {
      ...
      if (container != null)
      {
         org.gatein.portal.webui.container.UIContainer uiContainer =
            createUIComponent(org.gatein.portal.webui.container.UIContainer.class, null, null);
