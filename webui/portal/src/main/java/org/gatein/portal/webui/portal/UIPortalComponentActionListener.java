...
import org.gatein.portal.webui.container.UITabContainer;
import org.gatein.portal.webui.login.UILogin;
import org.gatein.portal.webui.login.UIResetPassword;
...
import org.gatein.webui.core.UITabPane;
...
public class UIPortalComponentActionListener
{
   ...
   static public class DeleteComponentActionListener extends EventListener<UIComponent>
   {
      public void execute(Event<UIComponent> event) throws Exception
      {
         ...
         org.gatein.portal.webui.container.UIContainer uiParent = uiComponentTobeRemoved.getParent();
         ...
         else if (org.gatein.portal.webui.container.UIContainer.TABLE_COLUMN_CONTAINER.equals(uiParent.getFactoryId()))
         {
            if (uiParent.getChildren().size() == 1)
            {
               uiComponentTobeRemoved = uiParent;
   ...
   static public class MoveChildActionListener extends EventListener<UIContainer>
   {
      public void execute(Event<UIContainer> event) throws Exception
      {
         ...
         if (uiSource == null)
         {
            ...
            {
               org.gatein.portal.webui.container.UIContainer uiContainer =
                  uiTarget.createUIComponent(org.gatein.portal.webui.container.UIContainer.class, null, null);
         ...
         org.gatein.portal.webui.container.UIContainer uiParent = uiSource.getParent();
         ...
         else if (org.gatein.portal.webui.container.UIContainer.TABLE_COLUMN_CONTAINER.equals(uiParent
