...
public class UIFormInputSetWithAction extends UIFormInputSet implements UIFormInput
{
   ...
   /* (non-Javadoc)
    * @see org.gatein.webui.form.UIFormInput#getBindingField()
    */
   ...
   /* (non-Javadoc)
    * @see org.gatein.webui.form.UIFormInput#getValidators()
    */
   ...
   /* (non-Javadoc)
    * @see org.gatein.webui.form.UIFormInput#addValidator(java.lang.Class, java.lang.Object[])
    */
   ...
   /* (non-Javadoc)
    * @see org.gatein.webui.form.UIFormInput#getValue()
    */
   ...
   /* (non-Javadoc)
    * @see org.gatein.webui.form.UIFormInput#setValue(java.lang.Object)
    */
   @SuppressWarnings("unused")
   ...
   /* (non-Javadoc)
    * @see org.gatein.webui.form.UIFormInput#getTypeValue()
    */
   ...
   /* (non-Javadoc)
    * @see org.gatein.webui.form.UIFormInput#getLabel()
    */
