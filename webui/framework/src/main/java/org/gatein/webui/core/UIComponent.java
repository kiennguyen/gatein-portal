...
abstract public class UIComponent
{
   ...
   {
      org.gatein.webui.config.Event event = config.getUIComponentEventConfig(name);
      if (event == null)
      {
         return "??config??";
      }
   ...
   public <T> void broadcast(Event<T> event, Phase phase) throws Exception
   {
      ...
      org.gatein.webui.config.Event econfig = config.getUIComponentEventConfig(event.getName());
      if (econfig == null)
      {
         return;
      }
   ...
   public Event<UIComponent> createEvent(String name, Phase phase, WebuiRequestContext context) throws Exception
   {
      ...
      org.gatein.webui.config.Event econfig = config.getUIComponentEventConfig(name);
      if (econfig == null)
      {
         return null;
      }
   ...
   private MonitorEvent<UIComponent> createMonitorEvent(Phase phase, WebuiRequestContext context) throws Exception
   {
      ...
      org.gatein.webui.config.Event econfig =
