...
@ComponentConfigs({
   ...
   @ComponentConfig(type = org.gatein.organization.webui.component.UIUserInGroup.UIGridUser.class, id = "UIGridUser", template = "system:/groovy/webui/core/UIGrid.gtmpl")})
@Serialized
